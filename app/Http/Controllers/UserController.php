...
class UserController extends Controller
{
  ...
  public function activation(Request $request, $token)
  {
    ...
    if ($activations_id > 0) {
      ...
      return redirect()->route('core/acl::auth.login')->with('success', `Dear {{$name}}, Your account has already been activated`);
    } else {
      ...
      return redirect()->route('core/acl::auth.login')->with('success', `Dear {{$name}}, Your account is successfully activated, Please Log in to continue!`);
    }
  }
