    ...
    <section class="col-sm-6 ">
      ...
      <form class="form-container agency-section mt-3 mb-5" method="get" action="/agency-signUp">
        ...
        <div class="form-group form-check">
          ...
          <label class="form-check-label" for="exampleCheck1" style="color: #878787;">I am real estate agent</label><br>


          <input type="checkbox" class="form-check-input is-invalid" value="" id="exampleCheck2" required>
          <label class="form-check-label" for="exampleCheck2" style="color: #878787;">
            I agree to Makanumber <a href="/customer-service" style="color: #00b4a2 !important;">privacy policy</a></label>
        </div>
        <button type="submit " style=" border: 1px rgb(0,180,162); border-radius: 5px; ; background: rgb(0,180,162);" class="btn btn-primary btn-lg mb-3">Sign up</button><br>

        <span style="color: #878787;">Already have an account?</span><a href="/admin/login" style="text-decoration: underline !important; "> Sign in</a>
      ...
      <form class="form-container member-section mt-3 mb-5" method="get" action="/member-signUp" style="display:none;">
        ...
        <div class="form-group form-check">
          ...
          <label class="form-check-label" for="exampleCheck12" style="color: black;">
            I agree to Makanumber <a href="/customer-service" style="text-decoration: underline !important; ">privacy policy</a></label>
        </div>
        ...
        <span style="color: black;">Already have an account?</span><a href="/admin/login" style="text-decoration: underline !important; "> Sign in</a>
