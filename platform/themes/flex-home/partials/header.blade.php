 ...
 <head>
   ...
   <meta
    content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5, user-scalable=1,shrink-to-fit=no" name="viewport" />
       ...
       <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item active" data-toggle="dropdown" >
         ...
         <li class="nav-item mt-1 ">
           <a href="/add-property"><button class="btn btn-default" style="border:1px solid #D3D3D3;">Add Property</button></a>
         </li>
         @endif
