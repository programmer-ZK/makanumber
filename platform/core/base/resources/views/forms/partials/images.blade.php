<div class="gallery-images-wrapper list-images">
  ...
  <div class="images-wrapper">
    <div data-name="{{ $name }}" class="text-center cursor-pointer js-btn-trigger-add-image default-placeholder-gallery-image @if (is_array($images) && !empty($images)) hidden @endif">
      ...
      <li class="gallery-image-item-handler">
        <div class="list-photo-hover-overlay">
          <ul class="photo-overlay-actions">
            <li>
              <a class="mr10 btn-trigger-edit-gallery-image" data-bs-toggle="tooltip" data-placement="bottom" data-bs-original-title="{{ trans('core/base::base.change_image') }}">
                <i class="fa fa-edit"></i>
              </a>
            </li>
            <li>
              <a class="mr10 btn-trigger-remove-gallery-image" data-bs-toggle="tooltip" data-placement="bottom" data-bs-original-title="{{ trans('core/base::base.delete_image') }}">
        ...
        <div class="custom-image-box image-box">
          ...
          <div class="preview-image-wrapper @if (!Arr::get($attributes, 'allow_thumb', true)) preview-image-wrapper-not-allow-thumb @endif">
            <img src="{{ RvMedia::getImageUrl($image, Arr::get($attributes, 'allow_thumb', true) == true ? ' ' : null) }}" alt="{{ trans('core/base::base.preview_image') }}" class="preview_image">
          </div>
        </div>
      </li>
      @endif
  ...
  <a href="#" class="add-new-gallery-image js-btn-trigger-add-image" data-name="{{ $name }}">{{ trans('core/base::base.add_image') }}
  </a>
</div>
