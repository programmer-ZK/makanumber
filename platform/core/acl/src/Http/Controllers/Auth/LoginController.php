...
class LoginController extends BaseController
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if (!empty($user)) {
            if (!app(ActivationInterface::class)->completed($user)) {
                return $this->response
                    ...
                    // ->setMessage('danger', 'You cannot login untill Admin Approves you'); 
        ...
        return $this->sendFailedLoginResponse($request)->with('danger', 'You cannot login untill Admin Approves you');
    }
