...
class ForgotPasswordController extends BaseController
{
    ...
    */
    ...
    protected function sendResetLinkResponse(Request $request, $response)
    {
        ...
        // return $this->response->setMessage('Check your Email, sent Successfully!')->toResponse($request);
        // return back()->with('success', 'Check your Email, sent Successfully!');
        return redirect::back()->with('success', 'Check your Email, sent Successfully!');
    }
}
